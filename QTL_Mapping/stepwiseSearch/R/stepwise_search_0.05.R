...
leafCountQTL <- stepwiseqtl(sorghum_data, pheno.col=3, max.qtl=10, penalties=calc.penalties(leafCountAll, alpha=0.05), verbose=FALSE)
...
leafAngleQTL <- stepwiseqtl(sorghum_data, pheno.col=4, max.qtl=10, penalties=calc.penalties(leafAngleAll, alpha=0.05), verbose=FALSE)
...
stalkHeightQTL <- stepwiseqtl(sorghum_data, pheno.col=5, max.qtl=10, penalties=calc.penalties(stalkHeightAll, alpha=0.05), verbose=FALSE)
...
panicleExsertionQTL <- stepwiseqtl(sorghum_data, pheno.col=6, max.qtl=10, penalties = calc.penalties(panicleExsertionAll, alpha=0.05), verbose=FALSE)
